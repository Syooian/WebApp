...
**專案位置：**[\Teacher\MyWebAPI](/Teacher/MyWebAPI/)  
**講義原始檔案：**[WeatherForecastController.cs](/Teacher/MyWebAPI/Controllers/WeatherForecastController.cs)

## 1. 製作我的第一個Web API(Restful API)
<p>1.1   建立CRUD API Ccontroller </P>
...
<p>1.3   使用Swagger Tool來進行ValuesController API的操作測試</p>
...
<p>3.1   建立Category資料的 API Ccontroller </P>
...
<p>4.5   同時取得Category及Product一對多的關聯資料</p>
...
<p>8.3   ProductsController程式碼重構</p>

* 8.3.1 在Service資料夾中建立ProductService，並將ProductsController裡的Get Action相關的商業邏輯移至此撰寫(包括ItemProduct()方法一併移入ProductService)
...
<p>9.3   使用ASP.net MVC的View來顯示資料</p>
