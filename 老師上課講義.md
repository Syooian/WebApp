...
<ul>
    <li>模型類別：tStudent(MyModel_DBFirst.Models)</li>
    <li>資料內容類別：dbStudentsContext(MyModel_DBFirst.Models)</li>
    <li>勾選「<strong>產生檢視</strong>」</li>
    <li>勾選「<strong>參考指令碼程式庫</strong>」</li>
    <li>勾選「<strong>使用版面配置頁</strong>」</li>
    <li>控制器名稱使用預設即可(tStudentsController)</li>
    <li>按下「<strong>新增</strong>」鈕</li>
<ul>
