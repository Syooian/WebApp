...
public partial class GoodStoreContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CateID).HasName("PK__Category__27638D74B47B6499");
        ...
        {
            entity.HasKey(e => e.MemberID).HasName("PK__Member__0CF04B380A2B6ECE");

            entity.HasIndex(e => e.Account, "UQ__Member__B0C3AC46955B34E1").IsUnique();
        ...
        {
            entity.HasKey(e => e.OrderID).HasName("PK__Order__C3905BAF1F546CE1");
        ...
        {
            entity.HasKey(e => new { e.OrderID, e.ProductID }).HasName("PK__OrderDet__08D097C120CE4984");
        ...
        {
            entity.HasKey(e => e.ProductID).HasName("PK__Product__B40CC6ED9B14B1D5");
